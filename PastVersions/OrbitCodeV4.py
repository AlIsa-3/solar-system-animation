...
mercury = CelestialBody("Mercury", "white", 30, 5, (MercuryOrbVel, 0), orbital_velocity(MercuryOrbVel))
earth = CelestialBody("Earth", "blue", 100, 10, (EarthOrbVel, 0), orbital_velocity(EarthOrbVel))#temp arbitrry units
mars = CelestialBody("Mars", "red", 80, 8, (MarsOrbVel, 0), orbital_velocity(MarsOrbVel))
venus = CelestialBody("Venus", "orange", 90, 9, (VenusOrbVel, 0), orbital_velocity(VenusOrbVel))
jupiter = CelestialBody("Jupiter", "brown", 500, 20, (JupiterOrbVel, 0), orbital_velocity(JupiterOrbVel))
#saturn = CelestialBody("Saturn", "gold", 400, 18, (950, 0), orbital_velocity(950))

bodies = [sun, mercury, venus, earth, mars, jupiter] #postioning order
