...
G = 0.5  #gravitational constant for stability (adjust)
...
def orbital_velocity(distance):
    speed = 0 #math.sqrt(G * SUN_MASS / distance)#mathematical formula for spd using g/m/r
    return [0, speed]
...
bodies = [sun, earth] #postioning order
