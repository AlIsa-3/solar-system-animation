...
G = 0.0001 #1*10**-6  #gravitational constant for stability (adjust)
TIME_STEP = 1  # time increment per frame
SUN_MASS = 1988400 #Arbitrary value for the oslar mass to make the simulation stable
...
moon = CelestialBody("Moon", "White", Mo_M, 3, (150, 0), orbital_velocity(3600))
...
bodies = [sun, venus, mercury, earth, moon, mars, jupiter]
#x-axis
